#/bin/sh
#
# from https://gist.github.com/damoclark/ab3d700aafa140efb97e510650d9b1be
# Simple Raspbian Configuration - Add file to boot partition of SD card and run command after booting Raspbian.
# Replace name of file in instructions below with the name of this file to work, including running the initial configuration command.
#
